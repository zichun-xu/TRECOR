...
for(rank in ranks){
  print(paste0("Running: rank-",rank," covariance regression on normalized data with GL prior"))
  ...
  note = paste0("Real data: rank", rank, "Covariance matrix regression on normalized data with the graphical LASSO prior")
  
  save(result, WAIC, 
       date_of_run, note, 
       file = paste0(result_path, "R_",rank,"_cov_reg_chain_", chain, "_iter_", touse, sep=""))
}
